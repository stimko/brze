...
/******/ 	var hotCurrentHash = "56f7932446e147493eec"; // eslint-disable-line no-unused-vars
...
var _user$project$SharedStyles_Colors$black = _rtfeldman$elm_css$Css$hex('000000');
var _user$project$SharedStyles_Colors$grey = _rtfeldman$elm_css$Css$hex('DADADA');
var _user$project$SharedStyles_Colors$white = _rtfeldman$elm_css$Css$hex('FFFFFF');
var _user$project$SharedStyles_Colors$brzeGreen = _rtfeldman$elm_css$Css$hex('00a39c');
var _user$project$SharedStyles_Colors$primary = _user$project$SharedStyles_Colors$brzeGreen;

var _user$project$BrzeCss$NumWrapper = {ctor: 'NumWrapper'};
var _user$project$BrzeCss$Currently = {ctor: 'Currently'};
var _user$project$BrzeCss$Steps = {ctor: 'Steps'};
var _user$project$BrzeCss$Num = {ctor: 'Num'};
var _user$project$BrzeCss$Introducing = {ctor: 'Introducing'};
var _user$project$BrzeCss$Finally = {ctor: 'Finally'};
var _user$project$BrzeCss$Carriers = {ctor: 'Carriers'};
var _user$project$BrzeCss$Title = {ctor: 'Title'};
var _user$project$BrzeCss$Intro = {ctor: 'Intro'};
var _user$project$BrzeCss$MakingPickupEasy = {ctor: 'MakingPickupEasy'};
var _user$project$BrzeCss$Easy = {ctor: 'Easy'};
var _user$project$BrzeCss$VerticalBrze = {ctor: 'VerticalBrze'};
var _user$project$BrzeCss$BrzeLogo = {ctor: 'BrzeLogo'};
var _user$project$BrzeCss$css = function (_p0) {
		...
		_1: {
					...
					_1: {
						...
						_1: {
							...
							_0: A3(
								...
								_rtfeldman$elm_css$Css$em(5.0e-2),
								_rtfeldman$elm_css$Css$solid,
								_user$project$SharedStyles_Colors$grey),
							_1: {ctor: '[]'}
						}
					}
				}),
			_1: {
				...
				_0: A2(
					...
					_user$project$BrzeCss$Currently,
					{
						ctor: '::',
				...
				_1: {
					...
					_0: A2(
						_rtfeldman$elm_css$Css$class,
						_user$project$BrzeCss$NumWrapper,
						{
							ctor: '::',
							_0: A2(
					...
					_1: {
						...
						_1: {
							...
							_0: A2(
								_rtfeldman$elm_css$Css$class,
								_user$project$BrzeCss$VerticalBrze,
								{
									ctor: '::',
									_0: _rtfeldman$elm_css$Css$backgroundColor(_user$project$SharedStyles_Colors$black),
									_1: {
										ctor: '::',
										_0: A2(
											_rtfeldman$elm_css$Css$padding2,
											_rtfeldman$elm_css$Css$em(0.4),
										...
										_1: {
											...
											_1: {
												...
												_1: {
													...
													_1: {
														ctor: '::',
														_0: _rtfeldman$elm_css$Css$color(_user$project$SharedStyles_Colors$white),
														_1: {
															ctor: '::',
															_0: A2(_rtfeldman$elm_css$Css$property, 'text-orientation', 'sideways'),
															_1: {
																ctor: '::',
							...
							_1: {
								...
								_0: A2(
									_rtfeldman$elm_css$Css$class,
									_user$project$BrzeCss$BrzeLogo,
									{
										ctor: '::',
								...
								_1: {
									...
									_1: {
										...
										_0: A2(
											_rtfeldman$elm_css$Css$class,
											_user$project$BrzeCss$Num,
											{
												ctor: '::',
												_0: _rtfeldman$elm_css$Css$color(_user$project$SharedStyles_Colors$brzeGreen),
												_1: {
													ctor: '::',
													_0: _rtfeldman$elm_css$Css$fontWeight(
														_rtfeldman$elm_css$Css$int(500)),
										...
										_1: {
											...
											_0: A2(
												_rtfeldman$elm_css$Css$class,
												_user$project$BrzeCss$MakingPickupEasy,
												{
													ctor: '::',
													_0: _rtfeldman$elm_css$Css$fontWeight(
														_rtfeldman$elm_css$Css$int(200)),
											...
											_1: {
												...
												_0: A2(
													_rtfeldman$elm_css$Css$class,
													_user$project$BrzeCss$Carriers,
													{
														ctor: '::',
														_0: _rtfeldman$elm_css$Css$color(_user$project$SharedStyles_Colors$brzeGreen),
														_1: {
												...
												_1: {
													...
													_0: A2(
														_rtfeldman$elm_css$Css$class,
														_user$project$BrzeCss$Intro,
														{
															ctor: '::',
															_0: _rtfeldman$elm_css$Css$backgroundColor(_user$project$SharedStyles_Colors$brzeGreen),
															_1: {
																ctor: '::',
																_0: _rtfeldman$elm_css$Css$color(_user$project$SharedStyles_Colors$white),
																_1: {
																										...
																										_0: _rtfeldman$elm_css$Css$children(
																											{
																												...
																												_0: A2(
																													_rtfeldman$elm_css$Css$class,
																													_user$project$BrzeCss$Introducing,
																													{
																														ctor: '::',
																														_0: _rtfeldman$elm_css$Css$fontWeight(
																															_rtfeldman$elm_css$Css$int(500)),
...
var _user$project$SignUp_SignUpCss$SignUpTitle = {ctor: 'SignUpTitle'};
var _user$project$SignUp_SignUpCss$SignUp = {ctor: 'SignUp'};
var _user$project$SignUp_SignUpCss$SignUpButton = {ctor: 'SignUpButton'};
var _user$project$SignUp_SignUpCss$Input = {ctor: 'Input'};
var _user$project$SignUp_SignUpCss$InputWrapper = {ctor: 'InputWrapper'};
var _user$project$SignUp_SignUpCss$css = function (_p0) {
	return _rtfeldman$elm_css$Css$stylesheet(
		A2(_rtfeldman$elm_css$Css_Namespace$namespace, 'signUp', _p0));
}(
	{
		ctor: '::',
		_0: A2(
			_rtfeldman$elm_css$Css$class,
			_user$project$SignUp_SignUpCss$SignUpTitle,
			{
				ctor: '::',
				_0: _rtfeldman$elm_css$Css$fontSize(
					_rtfeldman$elm_css$Css$em(2)),
		...
		_1: {
			...
			_0: A2(
				_rtfeldman$elm_css$Css$class,
				_user$project$SignUp_SignUpCss$SignUp,
				{
					ctor: '::',
					_0: A3(
						_rtfeldman$elm_css$Css$borderTop3,
			...
			_1: {
				...
				_0: A2(
					_rtfeldman$elm_css$Css$class,
					_user$project$SignUp_SignUpCss$Input,
					{
						ctor: '::',
						_0: _rtfeldman$elm_css$Css$padding(
							_rtfeldman$elm_css$Css$em(0.2)),
				...
				_1: {
					...
					_0: A2(
						_rtfeldman$elm_css$Css$class,
						_user$project$SignUp_SignUpCss$InputWrapper,
						{
							ctor: '::',
					...
					_1: {
						...
						_0: A2(
							_rtfeldman$elm_css$Css$class,
							_user$project$SignUp_SignUpCss$SignUpButton,
							{
								ctor: '::',
								_0: _rtfeldman$elm_css$Css$width(
								...
								_1: {
									...
									_1: {
										...
										_1: {
											ctor: '::',
											_0: _rtfeldman$elm_css$Css$fontFamily(_rtfeldman$elm_css$Css$inherit),
											_1: {
												ctor: '::',
												_0: _rtfeldman$elm_css$Css$color(_user$project$SharedStyles_Colors$white),
												_1: {
...
var _user$project$SignUp_SignUp$viewValidation = function (model) {
	var _p0 = _elm_lang$core$Native_Utils.eq(model.password1, model.password2) ? {ctor: '_Tuple2', _0: 'green', _1: ''} : {ctor: '_Tuple2', _0: 'red', _1: 'Passwords do not match!'};
	var color = _p0._0;
	var message = _p0._1;
	return A2(
...
var _user$project$SignUp_SignUp$decodeGifUrl = A2(
	_elm_lang$core$Json_Decode$at,
	{
		ctor: '::',
		_0: 'data',
	...
	_elm_lang$core$Json_Decode$string);
var _user$project$SignUp_SignUp$toJson = function (m) {
	return _elm_lang$core$Json_Encode$object(
		{
			...
			_0: {
				ctor: '_Tuple2',
				_0: 'name',
				_1: _elm_lang$core$Json_Encode$string(m.name)
			},
			_1: {
				ctor: '::',
				_0: {
					ctor: '_Tuple2',
					_0: 'phoneNumber',
					_1: _elm_lang$core$Json_Encode$string(m.phoneNumber)
				},
				_1: {
					ctor: '::',
					_0: {
						ctor: '_Tuple2',
						_0: 'address1',
						_1: _elm_lang$core$Json_Encode$string(m.address1)
					},
					_1: {
						ctor: '::',
						_0: {
							ctor: '_Tuple2',
							_0: 'address2',
							_1: _elm_lang$core$Json_Encode$string(m.address2)
						},
						_1: {
							ctor: '::',
							_0: {
								ctor: '_Tuple2',
								_0: 'city',
								_1: _elm_lang$core$Json_Encode$string(m.city)
							},
							_1: {
								ctor: '::',
								_0: {
									ctor: '_Tuple2',
									_0: 'zip',
									_1: _elm_lang$core$Json_Encode$string(m.zip)
								},
								_1: {
									ctor: '::',
									_0: {
									...
									_1: {
										...
										_0: {
											ctor: '_Tuple2',
											_0: 'password1',
											_1: _elm_lang$core$Json_Encode$string(m.password1)
										},
										_1: {
											ctor: '::',
											_0: {
												ctor: '_Tuple2',
												_0: 'password2',
												_1: _elm_lang$core$Json_Encode$string(m.password2)
											},
											_1: {ctor: '[]'}
										}
									}
...
var _user$project$SignUp_SignUp$_p1 = _rtfeldman$elm_css_helpers$Html_CssHelpers$withNamespace('signUp');
var _user$project$SignUp_SignUp$id = _user$project$SignUp_SignUp$_p1.id;
var _user$project$SignUp_SignUp$class = _user$project$SignUp_SignUp$_p1.$class;
var _user$project$SignUp_SignUp$classList = _user$project$SignUp_SignUp$_p1.classList;
var _user$project$SignUp_SignUp$signUpInput = function (input) {
	return A2(
		_elm_lang$html$Html$div,
		{
			ctor: '::',
			_0: _user$project$SignUp_SignUp$class(
				{
					ctor: '::',
					_0: _user$project$SignUp_SignUpCss$InputWrapper,
					_1: {ctor: '[]'}
				}),
			_1: {ctor: '[]'}
		},
...
var _user$project$SignUp_SignUp$SignUpModel = function (a) {
	return function (b) {
		return function (c) {
			return function (d) {
				return function (e) {
							...
							return function (h) {
								return function (i) {
									return function (j) {
										return function (k) {
											return function (l) {
												return {name: a, phoneNumber: b, address1: c, address2: d, city: e, zip: f, email: g, password1: h, password2: i, signedUp: j, submitDisabled: k, signedUpErr: l};
											};
										};
									};
								};
...
var _user$project$SignUp_SignUp$signUpModel = _user$project$SignUp_SignUp$SignUpModel('')('')('')('')('')('')('')('')('')(false)(false)('');
var _user$project$SignUp_SignUp$SubmitSignUp = {ctor: 'SubmitSignUp'};
var _user$project$SignUp_SignUp$SignUpRequest = function (a) {
	return {ctor: 'SignUpRequest', _0: a};
};
var _user$project$SignUp_SignUp$signUpRequest = function (sumodel) {
	var test = A2(
		...
		A2(
			...
			0,
			_user$project$SignUp_SignUp$toJson(sumodel)));
	var url = '/api/signup';
	var request = A3(_elm_lang$http$Http$post, url, test, _user$project$SignUp_SignUp$decodeGifUrl);
	return A2(_elm_lang$http$Http$send, _user$project$SignUp_SignUp$SignUpRequest, request);
};
var _user$project$SignUp_SignUp$signUpUpdate = F2(
	function (msg, signUpModel) {
		var _p2 = msg;
		switch (_p2.ctor) {
			case 'Name':
				return {
			...
			case 'SubmitSignUp':
				return {
					ctor: '_Tuple2',
					_0: signUpModel,
					_1: _user$project$SignUp_SignUp$signUpRequest(signUpModel)
				};
			default:
				if (_p2._0.ctor === 'Ok') {
					return {
...
var _user$project$SignUp_SignUp$Password2 = function (a) {
	return {ctor: 'Password2', _0: a};
};
var _user$project$SignUp_SignUp$Password1 = function (a) {
	return {ctor: 'Password1', _0: a};
};
var _user$project$SignUp_SignUp$City = function (a) {
	return {ctor: 'City', _0: a};
};
var _user$project$SignUp_SignUp$Address2 = function (a) {
	return {ctor: 'Address2', _0: a};
};
var _user$project$SignUp_SignUp$Zip = function (a) {
	return {ctor: 'Zip', _0: a};
};
var _user$project$SignUp_SignUp$Address1 = function (a) {
	return {ctor: 'Address1', _0: a};
};
var _user$project$SignUp_SignUp$Email = function (a) {
	return {ctor: 'Email', _0: a};
};
var _user$project$SignUp_SignUp$PhoneNumber = function (a) {
	return {ctor: 'PhoneNumber', _0: a};
};
var _user$project$SignUp_SignUp$Name = function (a) {
	return {ctor: 'Name', _0: a};
};
var _user$project$SignUp_SignUp$signUpForm = function (signUpModel) {
	return A2(
		_elm_lang$html$Html$div,
		{ctor: '[]'},
		A2(
			...
			A2(
				_elm_lang$core$List$map,
				_user$project$SignUp_SignUp$signUpInput,
				{
					ctor: '::',
					_0: A2(
						_elm_lang$html$Html$div,
							...
							_1: {
								...
								_0: A2(
									_elm_lang$html$Html$input,
									{
										...
										_1: {
											ctor: '::',
											_0: _elm_lang$html$Html_Events$onInput(_user$project$SignUp_SignUp$Name),
											_1: {
												ctor: '::',
												_0: _user$project$SignUp_SignUp$class(
													{
														ctor: '::',
														_0: _user$project$SignUp_SignUpCss$Input,
														_1: {ctor: '[]'}
													}),
												_1: {ctor: '[]'}
											}
						...
						_0: A2(
							...
							{ctor: '[]'},
							{
								...
								_0: A2(
									...
									{
										ctor: '::',
										_0: _elm_lang$html$Html$text('Street Address*'),
										_1: {ctor: '[]'}
									}),
								_1: {
									ctor: '::',
									_0: A2(
										_elm_lang$html$Html$input,
										{
											...
											_1: {
												ctor: '::',
												_0: _elm_lang$html$Html_Events$onInput(_user$project$SignUp_SignUp$Address1),
												_1: {
													ctor: '::',
													_0: _user$project$SignUp_SignUp$class(
														{
							...
							_0: A2(
								...
								{ctor: '[]'},
								{
									...
									_0: A2(
										...
										{
											ctor: '::',
											_0: _elm_lang$html$Html$text('Apt., Floor, Unit etc. (Optional)'),
											_1: {ctor: '[]'}
										}),
									_1: {
										ctor: '::',
										_0: A2(
											_elm_lang$html$Html$input,
											{
												...
												_1: {
													ctor: '::',
													_0: _elm_lang$html$Html_Events$onInput(_user$project$SignUp_SignUp$Address2),
													_1: {
														ctor: '::',
														_0: _user$project$SignUp_SignUp$class(
															{
								...
								_0: A2(
									...
									{ctor: '[]'},
									{
										...
										_0: A2(
											...
											{
												ctor: '::',
												_0: _elm_lang$html$Html$text('Zip Code*'),
												_1: {ctor: '[]'}
											}),
										_1: {
											ctor: '::',
											_0: A2(
												_elm_lang$html$Html$input,
												{
													...
													_1: {
														ctor: '::',
														_0: _elm_lang$html$Html_Events$onInput(_user$project$SignUp_SignUp$Zip),
														_1: {
															ctor: '::',
															_0: _user$project$SignUp_SignUp$class(
																{
											...
											_1: {
												...
												_0: A2(
													_elm_lang$html$Html$input,
													{
														...
														_1: {
															ctor: '::',
															_0: _elm_lang$html$Html_Events$onInput(_user$project$SignUp_SignUp$City),
															_1: {
																ctor: '::',
																_0: _user$project$SignUp_SignUp$class(
																	{
												...
												_1: {
													...
													_0: A2(
														_elm_lang$html$Html$input,
														{
															...
															_1: {
																ctor: '::',
																_0: _elm_lang$html$Html_Events$onInput(_user$project$SignUp_SignUp$Password1),
																_1: {
																	ctor: '::',
																	_0: _user$project$SignUp_SignUp$class(
																		{
													...
													_1: {
														...
														_0: A2(
															_elm_lang$html$Html$input,
															{
																...
																_1: {
																	ctor: '::',
																	_0: _elm_lang$html$Html_Events$onInput(_user$project$SignUp_SignUp$Password2),
																	_1: {
																		ctor: '::',
																		_0: _user$project$SignUp_SignUp$class(
																			{
														...
														_1: {
															...
															_0: A2(
																_elm_lang$html$Html$input,
																{
																	...
																	_1: {
																		ctor: '::',
																		_0: _elm_lang$html$Html_Events$onInput(_user$project$SignUp_SignUp$Email),
																		_1: {
																			ctor: '::',
																			_0: _user$project$SignUp_SignUp$class(
																				{
															...
															_1: {
																...
																_0: A2(
																	_elm_lang$html$Html$input,
																	{
																		...
																		_1: {
																			ctor: '::',
																			_0: _elm_lang$html$Html_Events$onInput(_user$project$SignUp_SignUp$PhoneNumber),
																			_1: {
																				ctor: '::',
																				_0: _user$project$SignUp_SignUp$class(
																					{
				...
				}),
			{
				...
				_0: A2(
					...
					{
						ctor: '::',
						_0: _elm_lang$html$Html_Events$onClick(_user$project$SignUp_SignUp$SubmitSignUp),
						_1: {
							ctor: '::',
							_0: _user$project$SignUp_SignUp$class(
								{
									ctor: '::',
									_0: _user$project$SignUp_SignUpCss$SignUpButton,
									_1: {ctor: '[]'}
								}),
							_1: {
								ctor: '::',
								_0: _elm_lang$html$Html_Attributes$disabled(signUpModel.submitDisabled),
								_1: {ctor: '[]'}
							}
						}
					},
				...
				_1: {
					ctor: '::',
					_0: _user$project$SignUp_SignUp$viewValidation(signUpModel),
					_1: {ctor: '[]'}
				}
			}));
};
var _user$project$SignUp_SignUp$signUpView = function (signUpModel) {
	return A2(
		_elm_lang$html$Html$div,
		{
			ctor: '::',
			_0: _user$project$SignUp_SignUp$class(
				{
					ctor: '::',
					_0: _user$project$SignUp_SignUpCss$SignUp,
					_1: {ctor: '[]'}
				}),
			_1: {ctor: '[]'}
		},
			...
			_0: A2(
				_elm_lang$html$Html$div,
				{
					...
					_0: _user$project$SignUp_SignUp$class(
						{
							ctor: '::',
							_0: _user$project$SignUp_SignUpCss$SignUpTitle,
							_1: {ctor: '[]'}
						}),
					_1: {ctor: '[]'}
				},
				{
					ctor: '::',
					_0: _elm_lang$html$Html$text('Sign Up For Brze!'),
					_1: {ctor: '[]'}
				}),
			_1: {
				ctor: '::',
				...
				_1: {
					ctor: '::',
					_0: _user$project$SignUp_SignUp$signUpForm(signUpModel),
					_1: {ctor: '[]'}
				}
			}
		});
...
var _user$project$App$init = {
	ctor: '_Tuple2',
	_0: {signUp: _user$project$SignUp_SignUp$signUpModel},
	_1: _elm_lang$core$Platform_Cmd$none
};
var _user$project$App$userDecoder = A3(
									...
									A3(
										...
										A3(
											...
											A3(
												...
												'email',
												_elm_lang$core$Json_Decode$string,
												_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$decode(_user$project$SignUp_SignUp$SignUpModel)))))))))))));
var _user$project$App$_p0 = _rtfeldman$elm_css_helpers$Html_CssHelpers$withNamespace('main');
var _user$project$App$id = _user$project$App$_p0.id;
var _user$project$App$class = _user$project$App$_p0.$class;
var _user$project$App$classList = _user$project$App$_p0.classList;
var _user$project$App$num = function (n) {
	return A2(
		_elm_lang$html$Html$span,
		{
			ctor: '::',
			_0: _user$project$App$class(
				{
					ctor: '::',
					_0: _user$project$BrzeCss$Num,
					_1: {ctor: '[]'}
				}),
			_1: {ctor: '[]'}
		},
...
var _user$project$App$oneTwoThree = A2(
		...
		_0: A2(
			_elm_lang$html$Html$p,
			{
				...
				_0: _user$project$App$class(
					{
						ctor: '::',
						_0: _user$project$BrzeCss$VerticalBrze,
						_1: {ctor: '[]'}
					}),
				_1: {ctor: '[]'}
			},
			{
				ctor: '::',
				_0: _elm_lang$html$Html$text('Brze'),
				_1: {ctor: '[]'}
			}),
		_1: {
			ctor: '::',
			_0: A2(
				_elm_lang$html$Html$p,
				{
					...
					_0: _user$project$App$class(
						{
							ctor: '::',
							_0: _user$project$BrzeCss$Steps,
							_1: {ctor: '[]'}
						}),
					_1: {ctor: '[]'}
				},
				{
					...
					_0: A2(
						...
						{
							ctor: '::',
							_0: _elm_lang$html$Html$text('It’s as simple as '),
							_1: {
								ctor: '::',
								_0: A2(
									...
									{
										ctor: '::',
										_0: _elm_lang$html$Html$text('1, 2, 3'),
										_1: {ctor: '[]'}
									}),
								_1: {
									ctor: '::',
						...
						_0: A2(
							_elm_lang$html$Html$div,
							{
								...
								_0: _user$project$App$class(
									{
										ctor: '::',
										_0: _user$project$BrzeCss$NumWrapper,
										_1: {ctor: '[]'}
									}),
								_1: {ctor: '[]'}
							},
									...
									_0: A2(
										...
										{ctor: '[]'},
										{
											...
											_0: A2(
												...
												{
													ctor: '::',
													_0: _elm_lang$html$Html$text('TEXT US '),
													_1: {ctor: '[]'}
												}),
											_1: {
												ctor: '::',
												...
												_1: {
													...
													_0: A2(
														...
														{
															ctor: '::',
															_0: _elm_lang$html$Html$text('848.702.3698'),
															_1: {ctor: '[]'}
														}),
													_1: {ctor: '[]'}
												}
								...
								},
								{
									...
									_1: {
										...
										_0: A2(
											...
											{
												ctor: '::',
												_0: _elm_lang$html$Html$text('We come and pickup your packages*'),
												_1: {ctor: '[]'}
											}),
										_1: {ctor: '[]'}
									}
									...
									},
									{
										...
										_1: {
											...
											_0: A2(
												...
												{
													ctor: '::',
													_0: _elm_lang$html$Html$text('We text you a confirmation that inclides an image and tracking number after delivery'),
													_1: {ctor: '[]'}
												}),
											_1: {ctor: '[]'}
										}
									...
									_0: A2(
										_elm_lang$html$Html$p,
										{
											...
											_0: _user$project$App$class(
												{
													ctor: '::',
													_0: _user$project$BrzeCss$Currently,
													_1: {ctor: '[]'}
												}),
											_1: {ctor: '[]'}
										},
										{
											ctor: '::',
											_0: _elm_lang$html$Html$text('*Currently in Summit, NJ Only'),
											_1: {ctor: '[]'}
										}),
									_1: {ctor: '[]'}
								}
...
var _user$project$App$decodeModel = A3(
	_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$required,
	'signUp',
	_user$project$App$userDecoder,
	_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$decode(_user$project$App$Model));
var _user$project$App$SignUp = function (a) {
	return {ctor: 'SignUp', _0: a};
};
var _user$project$App$update = F2(
	function (message, state) {
		var _p1 = message;
		var _p2 = A2(_user$project$SignUp_SignUp$signUpUpdate, _p1._0, state.signUp);
		var signUpState = _p2._0;
		var cmd = _p2._1;
		return {
			ctor: '_Tuple2',
			_0: _elm_lang$core$Native_Utils.update(
				state,
				{signUp: signUpState}),
			_1: A2(_elm_lang$core$Platform_Cmd$map, _user$project$App$SignUp, cmd)
		};
	});
		...
		{ctor: '[]'},
		{
			...
			_0: A2(
				_elm_lang$html$Html$img,
				{
					...
					_0: _user$project$App$class(
						{
							ctor: '::',
							_0: _user$project$BrzeCss$BrzeLogo,
							_1: {ctor: '[]'}
						}),
					_1: {
						ctor: '::',
						_0: _elm_lang$html$Html_Attributes$src('/images/brze.png'),
						_1: {ctor: '[]'}
					}
				},
				{ctor: '[]'}),
			_1: {
						...
						_0: A2(
							_elm_lang$html$Html$span,
							{
								...
								_0: _user$project$App$class(
									{
										ctor: '::',
										_0: _user$project$BrzeCss$MakingPickupEasy,
										_1: {ctor: '[]'}
									}),
								_1: {ctor: '[]'}
							},
							{
								ctor: '::',
								_0: _elm_lang$html$Html$text('Making pickup easy! '),
								_1: {ctor: '[]'}
							}),
						_1: {
							ctor: '::',
							_0: A2(
								_elm_lang$html$Html$span,
								{
									...
									_0: _user$project$App$class(
										{
											ctor: '::',
											_0: _user$project$BrzeCss$Carriers,
											_1: {ctor: '[]'}
										}),
									_1: {ctor: '[]'}
								},
								{
									ctor: '::',
									_0: _elm_lang$html$Html$text('FedEx • USPS • UPS'),
									_1: {ctor: '[]'}
								}),
							_1: {ctor: '[]'}
						}
				...
				_1: {
					...
					_0: A2(
						_elm_lang$html$Html$p,
						{
							...
							_0: _user$project$App$class(
								{
									ctor: '::',
									_0: _user$project$BrzeCss$Intro,
									_1: {ctor: '[]'}
								}),
							_1: {ctor: '[]'}
						},
							...
							_0: A2(
								_elm_lang$html$Html$p,
								{
									...
									_0: _user$project$App$class(
										{
											ctor: '::',
											_0: _user$project$BrzeCss$Title,
											_1: {ctor: '[]'}
										}),
									_1: {ctor: '[]'}
								},
									...
									_0: A2(
										_elm_lang$html$Html$span,
										{
											...
											_0: _user$project$App$class(
												{
													ctor: '::',
													_0: _user$project$BrzeCss$Introducing,
													_1: {ctor: '[]'}
												}),
											_1: {ctor: '[]'}
										},
										{
											ctor: '::',
											_0: _elm_lang$html$Html$text('Introducing Brze. '),
											_1: {ctor: '[]'}
										}),
									_1: {
										ctor: '::',
										_0: A2(
											...
											{
												ctor: '::',
												_0: _elm_lang$html$Html$text('Returns Made Easy!'),
												_1: {ctor: '[]'}
											}),
										_1: {ctor: '[]'}
									}
								...
								_0: A2(
									_elm_lang$html$Html$p,
									{
										...
										_0: _user$project$App$class(
											{
												ctor: '::',
												_0: _user$project$BrzeCss$Finally,
												_1: {ctor: '[]'}
											}),
										_1: {ctor: '[]'}
									},
									{
										ctor: '::',
										_0: _elm_lang$html$Html$text('Finally, an affordable service that will pick up your package/s from your home and drop them off at '),
										_1: {
											ctor: '::',
											_0: A2(
												_elm_lang$html$Html$span,
												...
												{
													ctor: '::',
													_0: _elm_lang$html$Html$text('FedEx, USPS, or UPS.'),
													_1: {ctor: '[]'}
												}),
											_1: {ctor: '[]'}
										}
					...
					_1: {
						ctor: '::',
						_0: _user$project$App$oneTwoThree,
						_1: {
							ctor: '::',
							_0: A2(
								_elm_lang$html$Html$map,
								_user$project$App$SignUp,
								_user$project$SignUp_SignUp$signUpView(model.signUp)),
							_1: {ctor: '[]'}
						}
					}
				}
...
__webpack_require__("./src/Main.elm");
...
server.disable('x-powered-by').use(__WEBPACK_IMPORTED_MODULE_1_express___default.a.static("/Users/stephentimko/Documents/projects/brze/public")).use(bodyParser.urlencoded({ extended: true })).use(bodyParser.json()).post('/api/signup', function (req, res) {
  console.log("handle shit here");
}).get('/*', function (req, res) {
	console.log("GET", __WEBPACK_IMPORTED_MODULE_0_elm_static_html_lib___default());
  __WEBPACK_IMPORTED_MODULE_0_elm_static_html_lib___default()(process.cwd(), "App.view", options).then(function (generatedHtml) {
    ...
    res.send('<!doctype html>\n      <html lang="">\n        <head>\n            <meta httpEquiv="X-UA-Compatible" content="IE=edge" />\n            <meta charSet=\'utf-8\' />\n            <title>Welcome to Razzle</title>\n            <meta name="viewport" content="width=device-width, initial-scale=1">\n            <link rel="stylesheet" href="/reset.css">\n            <link rel="stylesheet" href="/fonts/fonts.css">\n            ' + (assets.client.css ? '<link rel="stylesheet" href="' + assets.client.css + '">' : '') + '          \n            \n        </head>\n        <body>\n            <div id="root">' + markup + '</div>\n        </body>\n        ' + ( false ? '<script src="' + assets.client.js + '"></script>' : '<script src="' + assets.client.js + '"></script>') + '\n      </html>');
